<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="editjuristype.aspx.vb" Inherits="PATMAP.editjuristype" %>
     ...
     <div class="commonContent">
       <div class="commonHeader">
             <div class="PageHeaderModule">
                <div class="Header">
                    <p class="Title"><asp:Label ID="lblTitle" runat="server" Text="Edit Jurisdiction Type"></asp:Label></p>
                </div>
            </div>
        </div>
        <div class="commonForm">
            ...
            <table cellpadding="0" cellspacing="0" border="0">
                 <tr>
                    ...
                    <td class="field" colspan="2"><asp:TextBox ID="txtJurisType" runat="server" CssClass="txtNormal"></asp:TextBox> <asp:ImageButton ID="btnHJurisType" runat="server" ImageUrl="~/images/btnHelp.gif" Visible="False" CssClass="btnHelp"></asp:ImageButton></td>
                 </tr>
                 <tr>
                    <td class="label">
