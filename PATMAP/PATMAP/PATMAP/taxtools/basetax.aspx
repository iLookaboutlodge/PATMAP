<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="basetax.aspx.vb" Inherits="PATMAP.basetax" %>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="mainContent" runat="server">
    <div class="commonContent">  
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <asp:UpdatePanel ID="uplBaseTax" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="grdBaseTax" runat="server" AutoGenerateColumns="False" CssClass="grdSmStyle" Width="90%" CellPadding="3" DataKeyNames="taxClassID">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Base Year Base Tax">
                                        <ItemTemplate>
                                            <asp:Textbox ID="txtBaseYearBaseTax" runat="server" Width="100px" Enabled="false" Text='<%# DataBinder.Eval(Container.DataItem,"baseBaseTax") %>'></asp:Textbox>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Model Base Tax">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtModelBaseTax" runat="server" Width="100px"  Text='<%# DataBinder.Eval(Container.DataItem,"modelBaseTax") %>' AutoPostBack="false" ></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
        ...
        <table cellspacing="1" cellpadding="3" rules="all" border="0" class="displayRevisions">
            <tr>
