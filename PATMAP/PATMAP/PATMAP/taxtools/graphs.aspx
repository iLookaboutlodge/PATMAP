<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="graphs.aspx.vb" Inherits="PATMAP.graphs2" %>
    ...
    <div class="commonContent">  
        <div class="commonHeader">
            ...
            <div class="PageHeaderModule">
                <div class="Header">
                    <p class="Title">Model Report Graphs</p>
                </div>
            </div>
        </div>
