<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="viewReport.aspx.vb" Inherits="PATMAP.viewReport" %>
...
<%--            <rsweb:ReportViewer ID="rpvReports" runat="server" height="1000px" ShowParameterPrompts="False" AsyncRendering="false"
            Width="100%"> 
        </rsweb:ReportViewer>--%>
