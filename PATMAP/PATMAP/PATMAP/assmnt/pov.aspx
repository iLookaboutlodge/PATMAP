<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="pov.aspx.vb" Inherits="PATMAP.pov" %>
                                ...
                                <asp:GridView ID="grdPOV" runat="server" CellPadding="3" AutoGenerateColumns="False" CssClass="grdSmStyle" DataKeyNames="taxClassID">
                                 <Columns>
                                     ...
                                     <asp:TemplateField HeaderText ="Base Year POV (%)" ItemStyle-HorizontalAlign="Center">
                                         <ItemTemplate>                                            
                                             <asp:TextBox ID="txtBasePOV" runat="server" Width="75" Text='<%# DataBinder.Eval(Container.DataItem,"BasePOV") & "%" %>' Enabled="false"></asp:TextBox>
                                         </ItemTemplate>                                 
                                     </asp:TemplateField>
                                     <asp:TemplateField HeaderText ="Subject Year POV (%)" ItemStyle-HorizontalAlign="Center">
                                         <ItemTemplate>
                                             <asp:TextBox ID="txtSubjectPOV" runat="server" Width="75" Text='<%# DataBinder.Eval(Container.DataItem,"SubjectPOV") & "%" %>' AutoPostBack="true" OnTextChanged="valueChanged"></asp:TextBox>                                                                                          
                                         </ItemTemplate>
                                     </asp:TemplateField>                                      
                                 </Columns>
